            ...
            <div class="container">
                <div class="row align-items-center justify-content-xl-between g-4 g-md-5">
                    ...
                    <div
                        ...
                        <!-- Title -->
                        <h1 class="mb-4 display-6">به zedd dev
...
{{--                        </div>--}}
                        ...
                        <div class=" position-relative">
                            <!-- Yellow background -->
                            <div class=" h-200px h-sm-300px shadow"></div>
                            <!-- Image -->
                            <img src="{{ Voyager::image(setting('site.me')) }}"
                                 class="position-absolute bottom-0 start-50 translate-middle-x rounded-4  border border-white" alt="">
                        </div>
